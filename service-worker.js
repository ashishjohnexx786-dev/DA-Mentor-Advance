const CACHE="da-mentor-pro-v1.1.1";
const ASSETS=["./","./index.html","./styles.css","./enhancements.css","./curriculum.js","./app.js","./hotfix.js","./enhancements.js","./manifest.webmanifest","./icon.svg"];
